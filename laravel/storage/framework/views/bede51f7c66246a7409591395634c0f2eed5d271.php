...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Apostas</h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Gerenciar Apostas</li>
                    <li class="breadcrumb-item active" aria-current="page">Apostas Lista</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="content">
    ...
    <div class="total_card">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <h4>Game ID</h4>
                    <h4 class="bold"><?php echo e($game->id); ?></h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <h4>Game Crash Point</h4>
                    <h4 class="bold"><?php echo e(number_format($game->crash_point ,2)); ?></h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <h4>Game Crash Time</h4>
                    <h4 class="bold"><?php echo e($game->crash_time); ?>s</h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <h4>Contagem total de apostas</h4>
                    <h4 class="bold"><?php echo e($game->total_user); ?></h4>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <h4>Valor total da aposta</h4>
                    <h4 class="bold">R$ <?php echo e(number_format($game->total_amount ,2)); ?></h4>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <h4>Contagem total de vitórias</h4>
                    <h4 class="bold"><?php echo e($game->total_win); ?></h4>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <h4>Valor total da vitória</h4>
                    <h4 class="bold">R$ <?php echo e(number_format($game->total_win_amount, 2)); ?></h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">Apostas</h3>
        </div>
        <div class="block-content">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons" id="user-table">
                    <thead>
                        <tr>
                            <th style="width: 10%;">ID do apostas</th>
                            <th style="width: 12%;">Nome do usuário</th>
                            <th style="width: 12%;">ponto de aposta</th>
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr data-id="<?php echo e($betting->id); ?>">
                            <td>
                                <?php echo e($betting->id); ?>

                            </td>
                            <td>
                                <?php echo e($betting->full_name); ?>

                            </td>
                            <td>
                                <?php echo e($betting->user_betting_point); ?>

                            </td>
                            <td>
                                R$ <?php echo e($betting->user_bet_amount); ?>

                            </td>
                            <td>
                                R$ <?php echo e($betting->user_earning); ?>

                            </td>
                            <td>
                                <?php echo e(timeago($betting->updated_at)); ?>
