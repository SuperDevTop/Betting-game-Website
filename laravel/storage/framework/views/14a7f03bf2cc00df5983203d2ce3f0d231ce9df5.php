...
">
                                        ...
                                        <form action="<?php echo e(route('register')); ?>" method="POST">
                                            ...
                                            <input name="id" value="<?php echo e(isset($id)?$id:0); ?>" hidden>

                                            <div class="form-group">

                                                <input type="text" class="form-control form-control-alt" name="full_name" value="<?php echo e(old('full_name')); ?>" placeholder="nome completo">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-alt" name="email" value="<?php echo e(old('email')); ?>" placeholder="E-mail">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-alt" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="telefone">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-checkbox custom-control-primary">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="signup-terms" name="terms" <?php if(old('terms')): ?> checked="" <?php endif; ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p style="margin:10px 0px 0px 0px; text-align: center;"><a href="<?php echo e(url('/login')); ?>" style="margin-bottom: 0px; color: #FFF;">Volte ao login</a></p>
                                ...
                                <div class="col-md-6 order-md-0 bg-xeco-op d-flex align-items-center" style="display: none !important;">
                                    ...
                                    <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                        ...
                                        <div class="media">
                                            ...
                                            <a class="img-link mr-3" href="<?php echo e(url('/')); ?>">

                                                <img class="img-avatar img-avatar-thumb" src="<?php echo e(asset('front-assets/assets/images/logomr.png')); ?>" alt="">
