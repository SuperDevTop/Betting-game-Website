...
<div class="content-header">
    ...
    border: 1px solid #666;" class="btn btn-danger" id="balance" balance="<?php echo e(Auth::user()->balance); ?>">R$ <?php echo e(Auth::user()->balance); ?></button>&nbsp;
        <a class="btn btn-danger" href="<?php echo e(url('../transacoes/deposito')); ?>">Depositar</a>&nbsp;
        <div class="dropdown d-inline-block">
            <button type="button" class="btn btn-primary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="border-color:#999999; border-width: 2px;">
                ...
                <span class="d-none d-sm-inline-block">&nbsp;<?php echo e(Auth::user()->full_name); ?>&nbsp;</span>
            ...
            <div class="dropdown-menu dropdown-menu-right p-0" aria-labelledby="page-header-user-dropdown">
                ...
                <div class="p-2">
                    ...
                    <!--a class="dropdown-item" href="<?php echo e(url('withdraw')); ?>"-->
