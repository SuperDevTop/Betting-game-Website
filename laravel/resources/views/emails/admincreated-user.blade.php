@component('mail::layout')
    ...
    @slot('header')
        @component('mail::header', ['url' => config('app.url'),"class"=>"header-top-bordered"])
            <div class="header-center">
                <span class="no-float">Welcome User</span>
            </div>
        @endcomponent
    @endslot
    ...
    <div>
        ...
        <p class="mail-body-text">
            Greetings, your account is created by  <strong> {{ config('app.name') }}</strong> administrator.</br> Use the password mentioned below to signin:
        </p>
