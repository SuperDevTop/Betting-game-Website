                    ...
                    <div class="row w-100 text-center">
                        <div class="col-6 col-xl-4 offset-xl-4 invisible" data-toggle="appear" data-timeout="300">
                            <p class="font-size-h3 font-w600 text-body-color-dark mb-0">
                                R$ {{number_format($total_betting_amount, 2)}}
                            </p>
                        ...
                        <div class="col-6 col-xl-4 invisible" data-toggle="appear" data-timeout="600">
                            <p class="font-size-h3 font-w600 text-body-color-dark mb-0">
                                R$ {{number_format($total_betting_amount - $total_win_amount, 2)}}
                            </p>
                            <p class="font-size-sm font-w700 text-uppercase mb-0">
            ...
            <a class="block block-rounded block-link-pop" href="javascript:void(0)">
                <div class="block-content block-content-full d-flex align-items-center justify-content-between" style="height: 128px;">
                    ...
                    <div class="ml-3 text-right">
                        ...
                        <p class="font-size-h3 font-w300 mb-0">
                            R$ {{number_format($total_deposit_amount, 2)}}
                        </p>
                    </div>
                </div>
            </a>
            ...
            <a class="block block-rounded block-link-pop" href="javascript:void(0)">
                <div class="block-content block-content-full d-flex align-items-center justify-content-between" style="height: 128px;">
                    ...
                    <div class="ml-3 text-right">
                        ...
                        <p class="font-size-h3 font-w300 mb-0">
                            R$ {{number_format($affiliate_amount, 2)}}
                        </p>
                    </div>
                </div>
            </a>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center">
                                    <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{asset('admin-assets/theme/media/avatars/avatar3.jpg')}}" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{asset('admin-assets/theme/media/avatars/avatar10.jpg')}}" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{asset('admin-assets/theme/media/avatars/avatar11.jpg')}}" alt="">
                                </td>
                                <td>
...
@section('js')
<script src="{{asset('admin-assets/theme/js/plugins/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
<script src="{{asset('admin-assets/theme/js/plugins/chart.js/Chart.bundle.min.js')}}"></script>

<!-- Page JS Code -->
<script src="{{asset('admin-assets/theme/js/pages/be_pages_dashboard.min.js')}}"></script>
@endsection