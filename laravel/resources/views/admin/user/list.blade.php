                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons" id="user-table">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{$user->id}}" status="{{$user->status}}">
                            ...
                            <td>{{$user->referral_users}}</td>
                            <td>R$ {{number_format($user->referral_earning)}}</td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn btn-danger" href="{{url('admin/BlockUser/'.$user->id)}}">
                                        Bloquear
                                    </a>
                                    <a class="btn btn-primary" href="{{url('admin/UserCrashGames/'.$user->id)}}">
                                        <i class="si si-game-controller"></i>
                                    </a>
                                    <a class="btn btn-success" href="{{url('admin/LoginUser/'.$user->id)}}" target="_blank">
                                        <i class="si si-login"></i>
                                    </a><!-- 
                                    <a class="btn btn-primary" href="{{url('admin/ReferralUserListView/'.$user->id)}}" title="Usuários de referência">
