        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <h4 class="bold">{{$game_cnt}}</h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <h4>Valor total da aposta</h4>
                    <h4 class="bold">R$ {{number_format($game_total_amount, 2)}}</h4>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <h4>Ganhos totais</h4>
                    <h4 class="bold">R$ {{number_format($game_total_win_amount, 2)}}</h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons" id="user-table">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{$game->id}}">
                            ...
                            <td>
                                R$ {{$game->total_win_amount}}
                            </td>
                            <td>
                                {{timeago($game->created_at)}}
                            </td>
                            <td>
                                <a class="btn btn-primary" href="{{url('admin/GameBettingsList/'.$game->id)}}">
