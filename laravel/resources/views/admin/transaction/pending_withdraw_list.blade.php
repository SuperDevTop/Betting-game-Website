                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons" id="pending-table">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{$withdraw->id}}">
                            <td>
                                <div class="custom-control custom-checkbox mb-1">
                                    <input type="checkbox" class="custom-control-input" id="delete_checkbox-{{$withdraw->id}}"/>
                                    <label class="custom-control-label" for="delete_checkbox-{{$withdraw->id}}"></label>
                                </div>
                            </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <form action="{{url('admin/PayWithdrawPost')}}" method="post">
                    @csrf
                <div class="block-content">
