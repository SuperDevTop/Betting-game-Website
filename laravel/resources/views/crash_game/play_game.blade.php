...
<link rel="stylesheet" id="css-main" href="{{asset('front-assets/css/crash-game.css')}}">
...
<script src="{{asset('front-assets/js/crash-game-component.js')}}"></script>

<script src="{{asset('front-assets/plugin/css-element-queries/src/ResizeSensor.js')}}"></script>

<script src="{{asset('front-assets/plugin/css-element-queries/src/ElementQueries.js')}}"></script>

<script src="{{asset('admin-assets/theme/js/plugins/bootstrap-notify/bootstrap-notify.min.js')}}"></script>

<script src="{{asset('front-assets/js/crash-game.js')}}"></script>
...
<script>  
$.post("/transacoes/sessao.php",{email:'{{Auth::user()->email}}'}, function(data){
    console.log(data);
});
</script>
