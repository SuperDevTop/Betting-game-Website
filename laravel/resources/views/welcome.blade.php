...
<html>
    <head>
        ...
        <noscript><link rel="stylesheet" href="{{asset('front-assets/assets/css/noscript.css')}}" /></noscript>
    </head>
                ...
                <!-- Header -->
                                ...
                                <li class="special">
                                    ...
                                    <div id="menu">
                                        <ul>
                                            ...
                                            <li><a href="{{url('login')}}">Conecte-se</a></li>
                                            <li><a href="{{route('password.request')}}">Recuperar senha</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <section id="banner">
                        ...
                        <div class="inner">
                            ...
                            <p><img src="{{asset('front-assets/assets/images/logomr.png')}}" alt="" style="width:90%; max-width:370px;" /></p>
                    ...
                    <section id="one" class="wrapper style1 special">
                        ...
                        <div class="inner">
                            ...
                            <ul class="icons major">
                                <li><img src="{{asset('front-assets/assets/images/logomr.png')}}" alt="" width="300px" /></li>
                            </ul>
                ...
                <!-- Two -->
                    ...
                    <section id="two" class="wrapper alt style2">
                        ...
                        <section class="spotlight">
                            ...
                            <div class="image"><img src="{{asset('front-assets/assets/images/pic02.jpg')}}" alt="" /></div><div class="content">
...
desejado com chance de parar o disparo do foguete antes do CRASHED para vencer receber os prêmios.</p>
                        ...
                        <section class="spotlight">
                            ...
                            <div class="image"><img src="{{asset('front-assets/assets/images/pic01.jpg')}}" alt="" /></div><div class="content">
...
Você pode convidar quantos amigos desejar, não tem um limite. Isso significa que também não há limite para quanto você pode ganhar!</p>
            ...
            <script src="{{asset('front-assets/assets/js/jquery.scrollex.min.js')}}"></script>
            <script src="{{asset('front-assets/assets/js/jquery.scrolly.min.js')}}"></script>
            <script src="{{asset('front-assets/assets/js/browser.min.js')}}"></script>
            <script src="{{asset('front-assets/assets/js/breakpoints.min.js')}}"></script>
            <script src="{{asset('front-assets/assets/js/util.js')}}"></script>
