...
<div class="container">
    ...
    <div class="withdraw_card">
        ...
        <form method="post" action="{{url('withdraw_request_post')}}">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="account_type" required="">
                    ...
                    <option @if(old('account_type')=="checking_account") selected @endif value="checking_account">Conta Corrente</option>

                    <option @if(old('account_type')=="saving_account") selected @endif value="saving_account">Conta Poupança</option>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" min="50" class="form-control" name="amount" value="{{old('amount')}}"/>
